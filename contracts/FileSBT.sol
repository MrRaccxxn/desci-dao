...
contract FileSBT is ERC721, ERC721URIStorage, AccessControl {
    ...
    function safeMint(address to, string memory uri) public onlyRole(SBT_OWNER){
        require(hasRole(EDITOR_ROLE, msg.sender), "Err: Caller is not Editor");
